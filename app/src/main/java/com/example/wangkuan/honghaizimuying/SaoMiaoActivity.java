...
public class SaoMiaoActivity extends AppCompatActivity implements QRCodeView.Delegate {

    //打log用的常量
    private static final String TAG = SaoMiaoActivity.class.getSimpleName();
